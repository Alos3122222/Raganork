...
Asena.addCommand({on: 'text', fromMe: false}, (async (message, match) => {
    if (message.jid.includes(Config.YAK)) {
        ...
        if (!!message.mention && message.mention[0] == '917034860457@s.whatsapp.net') {
...
const array = ['Ayin','Ayinu','Bgm','Bot','Bye','Da','Good night','Hello','Hi','Neymar','Pm','Sed','alive','assist','ban','bgm','bot','converting','fake','fork','fuck','music','myre','njan','number','oombi','para','poda','DOT','remove','reply','sed','subscribe','umma','xxxtentation']
array.map( async (a) => {
